...
<center><br><br>
	<form method="post" action="/laptop" enctype="multipart/form-data">
	@csrf
	<div class="card text-white bg-dark mb-3" style="max-width: 25rem;">
		<div class="card-header"><h4>Add New Laptops</h4></div>
			<div class="card-body">
				<h5 class="card-title">
				<label for="laptop_pic">Laptop Photo</label>
				<input type="file" name="laptop_pic" class="form-control {{ $errors->has('laptop_pic') ? ' is-invalid' : '' }}" value="{{ old('laptop_pic') }}">
				</h5>
				<span>
				{{-- Display errors --}}
				...
				<textarea rows="5" cols="100" type="text" class="form-control" id="specification" name="specification" placeholder="specification of laptop"></textarea>
				</h5>
				<span>
				{{-- Display errors --}}
