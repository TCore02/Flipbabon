...
<center><br><br>
	<form method="post" action="/mobiles/{{$item->id}}" enctype="multipart/form-data">
		@method('PUT')
		@csrf
	<div class="card text-white bg-dark mb-3" style="max-width: 25rem;">
		<div class="card-header"><h4>Edit the details of Mobiles</h4></div>
			<div class="card-body">
				...
				<input type="file" name="mobile_pic" class="form-control{{ $errors->has('mobile_pic') ? ' is-invalid' : '' }}" value="{{$item->mobile_pic}}">
				</h5>
				<span>
				{{-- Display errors --}}
				...
				<textarea rows="5" cols="100" type="text" class="form-control" id="specification" name="specification" placeholder="specification of mobile">{{$item->specification}}</textarea>
				</h5>
				<span>
				{{-- Display errors --}}
